...
create view servicos_mais_registrados as
    SELECT s.tipo_servico, COUNT(l.id_livro) AS total_por_tipo
    FROM livro l
    JOIN servico s ON l.fk_servico_id_servico = s.id_servico
