...
CREATE ROLE gerente_escola;
CREATE ROLE vendedor_livraria;
CREATE ROLE organizador_eventos;

GRANT INSERT, DELETE ON disciplina TO coordenador;
GRANT INSERT, DELETE ON departamento TO gerente_escola;
GRANT INSERT, DELETE ON cadastro TO vendedor_livraria;
GRANT INSERT, DELETE ON palestra_debate TO organizador_eventos;
